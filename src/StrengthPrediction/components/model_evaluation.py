...
from src.StrengthPrediction.utils.utils import load_object
...
class ModelEvaluation:
    ...
    def evaluate(self, test_array):
        try:
            ...
            mlflow.set_registry_uri("https://dagshub.com/Mahi-29/ConcreteCompressiveStrengthPrediction.mlflow")
